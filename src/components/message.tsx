...
export const Message = ({
  ...
  const { parentMessageId, onOpenMessage, onOpeProfile, onClose } = usePanel();
          ...
          {isEditing ? (
            ...
            <div className="flex flex-col w-full overflow-hidden">
              <div className="text-sm">
                <button onClick={() => onOpeProfile(memberId)} className="font-bold text-primary hover:underline">{authorName}</button>
                <span>&nbsp;</span>
                <Hint label={formatFullTime(new Date(createdAt))}>
